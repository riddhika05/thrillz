...
const Follow = () => {
  ...
  const displayedUser = whisper ? whisper.users : { username: "Guest User", profilepic: "placeholder_url", whispers: 0 };

  // Check if the current profile belongs to the user with id 3
    ...
    >
      ...
      <div className="flex flex-col items-center gap-5 mt-5">
        <div className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden border-4 border-pink-300">
          <img
            src={isCurrentUserProfile ? "/path/to/myImage.png" : displayedUser.profilepic}
            alt="Profile"
      ...
      <h2 className="text-2xl md:text-3xl lg:text-4xl text-center mt-6 md:mt-8 text-white font-bold">
        {isCurrentUserProfile ? "My Whispers" : `${displayedUser.username}'s Whispers`}
      </h2>
