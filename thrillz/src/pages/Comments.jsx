...
const Chat = () => {
  ...
  const PostCard = () => {
    if (!whisper) {
      return (
        <div className="w-full mt-6 bg-white/80 rounded-2xl p-4 shadow-md text-center text-gray-700">
          No post selected.
        </div>
      );
    }
    return (
      <div className="w-full mt-6 bg-white/80 rounded-2xl p-4 shadow-md">
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 md:p-8">
        {/* Sticky header */}
        <div className="sticky top-0 left-0 flex items-center z-10 w-full">
          {/* Profile */}
          <img
            src={profileAvatar}
            alt="Profile Avatar"
